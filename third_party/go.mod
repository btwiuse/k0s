...
require (
	...
	k0s.io/pkg/asciitransport v0.1.13
	k0s.io/pkg/exporter v0.1.13
	k0s.io/pkg/middleware v0.1.13
	k0s.io/pkg/plugin v0.1.13
	k0s.io/pkg/rng v0.1.13
	k0s.io/pkg/tunnel v0.1.13
	k0s.io/pkg/utils v0.1.13
	k0s.io/pkg/uuid v0.1.13
	k8s.io/api v0.29.1
