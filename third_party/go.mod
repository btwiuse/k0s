...
require (
	...
	k0s.io/pkg/agent v0.1.18-alpha.3
	k0s.io/pkg/asciitransport v0.1.18-alpha.3
	k0s.io/pkg/middleware v0.1.18-alpha.3
	k0s.io/pkg/plugin v0.1.18-alpha.3
	k0s.io/pkg/tunnel v0.1.18-alpha.3
	k0s.io/pkg/utils v0.1.18-alpha.3
	k8s.io/api v0.32.0
