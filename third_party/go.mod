...
require (
	...
	k0s.io/pkg/asciitransport v0.1.7
	k0s.io/pkg/cli v0.1.7
	k0s.io/pkg/console v0.1.7
	k0s.io/pkg/dohserver v0.1.7
	k0s.io/pkg/exporter v0.1.7
	k0s.io/pkg/gitd v0.1.7
	k0s.io/pkg/plugin v0.1.7
	k0s.io/pkg/rng v0.1.7
