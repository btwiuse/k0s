...
func Run(args []string) error {
	flagset := flag.NewFlagSet("goproxy", flag.ContinueOnError)

	excludeHost = *flagset.String("exclude", "", "exclude host pattern")
	proxyHost = *flagset.String("proxy", "", "next hop proxy for go modules")
	cacheDir = *flagset.String("cacheDir", "", "go modules cache dir")
	listen = *flagset.String("listen", "0.0.0.0:8081", "service listen address")
