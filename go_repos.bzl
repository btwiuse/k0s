...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:59bfLgOICo4FdoxYDEBNq0t9jH9WqFT/LmL1NkS6upw=",
        version = "v0.0.0-20220903125123-b0bb26fc952b",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:c6vlM0jdCR8mzSoMMC4AdJOC6eLIOy+bFjvJDRmuJLE=",
        version = "v0.1.0-rc.1",
    )
    go_repository(
        ...
        sum = "h1:5I+mV3QlO/IIF5onr8qU9RregPf6seDeglC7BQkmrLc=",
        version = "v0.31.2-0.20230125230034-dfbfe71309ca",
    )
