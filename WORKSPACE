...
go_repository(
    ...
    sum = "h1:vh6cHU/sZBjdfYlKZOhXkMI5CTCgK12TauHGoQOue+4=",
    version = "v0.11.0",
)
...
go_repository(
    ...
    sum = "h1:54/W0/fvo1DexHbL2utsW4rDhr5RXgojsPD2TA5oEzI=",
    version = "v1.1.2",
)
...
go_repository(
    name = "com_github_gdr3941_websocketrpc",
    importpath = "github.com/gdr3941/websocketrpc",
    sum = "h1:OHVkSBVQcJ/rp6znuRHvYbPtimkfhQEloZ30zQXyzr8=",
    version = "v0.0.0-20180822040423-dd27c05c2bcb",
)
