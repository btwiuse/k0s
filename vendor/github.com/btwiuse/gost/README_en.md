...
[![GoDoc](https://godoc.org/github.com/btwiuse/gost?status.svg)](https://godoc.org/github.com/btwiuse/gost)
[![Go Report Card](https://goreportcard.com/badge/github.com/btwiuse/gost)](https://goreportcard.com/report/github.com/btwiuse/gost)
[![codecov](https://codecov.io/gh/ginuerzh/gost/branch/master/graphs/badge.svg)](https://codecov.io/gh/ginuerzh/gost/branch/master)
[![GitHub release](https://img.shields.io/github/release/ginuerzh/gost.svg)](https://github.com/btwiuse/gost/releases/latest)
...
<https://github.com/btwiuse/gost/releases>

#### From source

```bash
git clone https://github.com/btwiuse/gost.git
cd gost/cmd/gost
go build
```
