...
require (
	...
	k0s.io/pkg/apiserver v0.1.18-alpha.7
	k0s.io/pkg/client v0.1.18-alpha.7
	k0s.io/pkg/hub v0.1.18-alpha.7
	k0s.io/pkg/simple v0.1.18-alpha.7
	k0s.io/pkg/tunnel v0.1.18-alpha.7
	k0s.io/pkg/utils v0.1.18-alpha.7
...
require (
	...
	k0s.io/pkg/asciitransport v0.1.18-alpha.7 // indirect
	k0s.io/pkg/manager v0.1.18-alpha.7 // indirect
	k0s.io/pkg/middleware v0.1.18-alpha.7 // indirect
	k0s.io/pkg/ui v0.1.18-alpha.7 // indirect
