...
def _impl_android_armv7(ctx):
    ...
    tool_paths = [
        tool_path(
            name = "gcc",
            path = ANDROID_NDK_HOME + "/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi30-clang",
        ),
        tool_path(
            name = "ld",
            path = ANDROID_NDK_HOME + "/toolchains/llvm/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ld.gold",
        ),
        tool_path(
            name = "ar",
            path = ANDROID_NDK_HOME + "/toolchains/llvm/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ar",
        ),
        tool_path(
            name = "cpp",
            path = ANDROID_NDK_HOME + "/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi30-clang++",
