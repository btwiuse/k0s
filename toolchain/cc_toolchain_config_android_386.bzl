...
def _impl_android_386(ctx):
    ...
    tool_paths = [
        tool_path(
            name = "gcc",
            path = "/home/btwiuse/Android/Sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/i686-linux-android30-clang",
        ),
        tool_path(
            name = "ld",
            path = "/home/btwiuse/Android/Sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/i686-linux-android-ld.gold",
        ),
        tool_path(
            name = "ar",
            path = "/home/btwiuse/Android/Sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/i686-linux-android-ar",
        ),
        tool_path(
            name = "cpp",
            path = "/home/btwiuse/Android/Sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/i686-linux-android30-clang++",
